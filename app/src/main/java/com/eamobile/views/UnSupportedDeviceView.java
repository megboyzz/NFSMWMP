...
public class UnSupportedDeviceView extends CustomView {
    Dialog dialog;
    Button lskBtn;
    LinearLayout mainLayout;

    public UnSupportedDeviceView(Context context) {
        super(context);
    ...
    private void createContent(View view) {
        ...
        addTitle(this.context, this.mainLayout, Language.getString(27));
        ...
        textView.setText(Language.getString(28));
        ...
        this.lskBtn = addButton(this.context, linearLayout2, Language.getString(6));
    ...
    private void showContent(View view) {
        this.dialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
            /* class com.eamobile.views.UnSupportedDeviceView.AnonymousClass1 */
        ...
        this.lskBtn.setOnClickListener(new View.OnClickListener() {
            /* class com.eamobile.views.UnSupportedDeviceView.AnonymousClass2 */

            public void onClick(View view) {
                UnSupportedDeviceView.this.dialog.dismiss();
                DownloadActivityInternal.getMainActivity().startGameActivity(0);
            }
        });
        this.dialog.setOnKeyListener(new DialogInterface.OnKeyListener() {
            /* class com.eamobile.views.UnSupportedDeviceView.AnonymousClass3 */
