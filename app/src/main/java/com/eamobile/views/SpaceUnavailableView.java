...
public class SpaceUnavailableView extends CustomView {
    Dialog dialog;
    Button lskBtn;
    LinearLayout mainLayout;
    Button rskBtn;

    public SpaceUnavailableView(Context context) {
        super(context);
    ...
    private void createContent(View view) {
        ...
        addTitle(this.context, this.mainLayout, Language.getString(3));
        ...
        textView.setText(Language.getString(51, new String[]{DownloadActivityInternal.getMainActivity().getRequiredSpaceForDownload(), DownloadActivityInternal.getMainActivity().getAvailableSpaceForDownload()}));
        ...
        if (DownloadActivityInternal.getMainActivity().canOpenStorageSettings()) {
            this.lskBtn = addButton(this.context, linearLayout2, Language.getString(2));
        }
    ...
    private void showContent(View view) {
        this.rskBtn.setOnClickListener(new View.OnClickListener() {
            /* class com.eamobile.views.SpaceUnavailableView.AnonymousClass1 */

            public void onClick(View view) {
                SpaceUnavailableView.this.dialog.dismiss();
                try {
        ...
        if (DownloadActivityInternal.getMainActivity().canOpenStorageSettings()) {
            this.lskBtn.setOnClickListener(new View.OnClickListener() {
                /* class com.eamobile.views.SpaceUnavailableView.AnonymousClass2 */

                public void onClick(View view) {
                    SpaceUnavailableView.this.dialog.dismiss();
                    try {
                        DownloadActivityInternal.getMainActivity().startDataManagement();
                    } catch (Throwable th) {
                    }
                }
            });
        ...
        this.dialog.setOnKeyListener(new DialogInterface.OnKeyListener() {
            /* class com.eamobile.views.SpaceUnavailableView.AnonymousClass3 */
        ...
        this.dialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
            /* class com.eamobile.views.SpaceUnavailableView.AnonymousClass4 */
