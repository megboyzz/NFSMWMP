...
public class ServerErrorView extends CustomView {
    Dialog dialog;
    int errorCode = 0;
    Button lskBtn;
    ...
    private void createContent(View view) {
        ...
        addTitle(this.context, this.mainLayout, Language.getString(33));
        ...
        textView.setText(Language.getString(34, new String[]{"" + this.errorCode}));
    ...
    private void showContent(View view) {
        this.dialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
            /* class com.eamobile.views.ServerErrorView.AnonymousClass1 */
        ...
        this.lskBtn.setOnClickListener(new View.OnClickListener() {
            /* class com.eamobile.views.ServerErrorView.AnonymousClass2 */

            public void onClick(View view) {
                ServerErrorView.this.dialog.dismiss();
                DownloadActivityInternal.getMainActivity().startGameActivity(0);
            }
        });
        this.dialog.setOnKeyListener(new DialogInterface.OnKeyListener() {
            /* class com.eamobile.views.ServerErrorView.AnonymousClass3 */
